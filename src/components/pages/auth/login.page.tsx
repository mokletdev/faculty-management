...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-white to-blue-100 lg:flex-row">
      ...
      <div className="hidden lg:block lg:w-1/2">
        <Image
          src="/faculty-image.png?height=1080&width=1080"
          alt="University Building"
          width={1080}
          height={1080}
          className="h-[90%] w-full max-w-[688px] rounded-4xl object-cover"
          priority
        />
      </div>
    </div>
