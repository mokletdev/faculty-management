        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <PopoverTrigger asChild>
              <Button className="gap-2 border border-[#dadce0] bg-white font-medium text-[#1a73e8] transition-all hover:border-[#1a73e8] hover:bg-[#f6fafe] hover:shadow-sm">
                <GoogleCalendarIcon />
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <GoogleCalendarIcon />
              <h4 className="leading-none font-medium text-[#1a73e8]">
                Google Calendar
              </h4>
            </div>
            <p className="text-muted-foreground text-sm">
              Tambahkan kalender ini ke Google Calendar anda untuk tetap
              tersinkronisasi.
            </p>
          </div>
          ...
          <Button
            ...
            className="w-full gap-2 bg-[#1a73e8] text-white hover:bg-[#1765cc]"
          >
